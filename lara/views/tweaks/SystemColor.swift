...
struct SystemColor: View {
        ...
        NavigationStack {
            List {
                Section {
                    ...
                    Text("[注销重启](https://roooot.dev/respring.html) 以应用。 \n")
                    + Text(status)
                }
                ...
                Section {
                    HStack(alignment: .top) {
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Text("原版 [SystemColors Patcher](https://yupa-tt.github.io/SystemColor/)。")
                                .font(.subheadline)
    ...
    func apply() {
        ...
        do {
            ...
            status = "临时文件写入失败：\(error.localizedDescription)"
            return
        }
