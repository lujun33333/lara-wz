...
Require-Text 'lara/kexploit/WZHUDBridge.mm' 'metal background fallback frames=' '缺少后台离屏 fallback 提交诊断'
Require-Text 'lara/kexploit/WZHUDBridge.mm' 'g_metalSurfaceHealthy\.load\(\)' 'fallback 提交失败后仍会伪报 HUD 已运行'
Reject-Text 'lara/kexploit/WZHUDBridge.mm' 'g_backgroundRenderTimer|DISPATCH_SOURCE_TYPE_TIMER' '错误引入 Core 不使用的独立后台 timer'
