...
Require-Text 'scripts/WZHUDHostHelper.m' 'registerWindowWithContextID:atLevel:[\s\S]*v@:Id[\s\S]*SBSAccessibilityWindowHostingController' '独立 helper 未按 TrollSpeed 精确注册 context'
Reject-Text 'scripts/WZHUDHostHelper.m' 'RemoteCall|SBMainWorkspace|UIButton' '独立 helper 不应注入 SpringBoard 或创建菜单控件'
