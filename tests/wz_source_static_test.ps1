...
Require-Text 'lara/kexploit/WZHUDBridge.mm' 'wzhud_create_direct_springboard_float[\s\S]*setWindowScene:[\s\S]*setUserInteractionEnabled:[\s\S]*setHidden:' '直建浮球缺少窗口发布或触摸穿透设置'
...
Require-Text 'lara/kexploit/WZHUDBridge.h' 'wzhud_create_direct_springboard_float[\s\S]*wzhud_direct_springboard_float_ready[\s\S]*wzhud_remove_direct_springboard_float' '缺少 SpringBoard 直建浮球生命周期接口'
