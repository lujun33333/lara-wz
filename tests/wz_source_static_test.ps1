...
Require-Text 'lara/kexploit/TaskRop/vm.m' 'const uint64_t roundedsize = PAGE_SIZE;' 'mapped-pages 仍按整个 Unity vm_object 创建 named entry'
Require-Text 'lara/kexploit/TaskRop/vm.m' 'entry\.vme_offset = object->entryOffset >> 12;' '单页 named entry 未按 vme_offset 存储单位指向目标页'
