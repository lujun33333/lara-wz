...
Require-Text 'lara/kexploit/WZHUDBridge.mm' 'return self\.passthrough \? nil : \[super hitTest:point withEvent:event\];' 'HUD 绘制态未同步 Core 穿透命中语义'
Require-Text 'lara/kexploit/WZHUDBridge.mm' '\(void\)register_hosted_window_main\(\);' '可选 SBS 托管失败仍可能阻止 Core 系统窗口显示'
